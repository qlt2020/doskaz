 ...
 */
final class Version20200323143342 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cities (id INT NOT NULL, name TEXT NOT NULL, bounds_ne geography(POINT, 4326) NOT NULL, bounds_sw geography(POINT, 4326) NOT NULL, priority INT NOT NULL, PRIMARY KEY(id))');
