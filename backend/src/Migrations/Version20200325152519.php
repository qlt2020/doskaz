 ...
 */
final class Version20200325152519 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE profile_completion_tasks (user_id INT NOT NULL, progress INT NOT NULL, completed_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, PRIMARY KEY(user_id))');
        $this->addSql('COMMENT ON COLUMN profile_completion_tasks.completed_at IS \'(DC2Type:datetimetz_immutable)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE profile_completion_tasks');
        $this->addSql('ALTER TABLE adding_requests ALTER data TYPE JSONB');
        $this->addSql('ALTER TABLE adding_requests ALTER data DROP DEFAULT');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file TYPE JSONB');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file DROP DEFAULT');
