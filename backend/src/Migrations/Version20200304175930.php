 ...
 */
final class Version20200304175930 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE object_verifications (id UUID NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, user_id INT DEFAULT NULL, verified BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN object_verifications.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN object_verifications.updated_at IS \'(DC2Type:datetimetz_immutable)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE object_verifications');
        $this->addSql('ALTER TABLE adding_requests ALTER data TYPE JSONB');
        $this->addSql('ALTER TABLE adding_requests ALTER data DROP DEFAULT');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file TYPE JSONB');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file DROP DEFAULT');
