...
final class BearerTokenAuthenticator extends AbstractGuardAuthenticator
{
    ...
    {
        return $request->headers->has('Authorization') && $this->accessTokenRepository->find(substr($request->headers->get('Authorization', ''), 7));
    }
