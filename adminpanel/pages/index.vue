        ...
        computed: {
            ...
            links() {
                return [
                    ...
                    {path: '/blog/comments', key: 'blog_access', icon: 'fa fa-comment', title: 'Комментарии к медиатеке'},
                    ...
                    {path: '/reviews', key: 'reviews_access', icon: 'fa fa-search', title: 'Отзывы к объектам'},
