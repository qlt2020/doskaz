<template>
  <div class="timeline">
    <div class="timeline__tab-links">
      ...
      >
        <user-avatar class="avatar" :value="user.avatar"></user-avatar>
    ...
    <div class="timeline__tabs">
      <div
        class="timeline__tab timeline__tab_blog"
        :class="{ isActive: activeTab === 0 }"
      >
        <nuxt-link
          :to="localePath(`/blog/${post.categorySlug}/${post.slug}`)"
          class="item"
          v-for="post in postsShow"
          :key="post.id"
        >
          <div
            class="item__img"
            v-bind:style="{
              'background-image': 'url(' + post.previewImage + ')'
            }"
          ></div>
          <div class="item__info">
            ...
            <p class="item__text" v-html="post.annotation"></p>
          </div>
        </nuxt-link>
      ...
      <div
        class="timeline__tab timeline__tab_events"
        :class="{ isActive: activeTab === 1 }"
      >
        <div class="scroll">
            ...
            <div class="item__text">
              ...
              <template v-if="event.type === 'object_reviewed'">
                ...
                <span v-else-if="event.data.userId === userId">
                  {{ $t("events.objectReviewed.yourself") }}
                  <nuxt-link
                    :to="
                      localePath({
                        name: 'objects-id',
                ...
                <span v-else>
                  <username tag="b" :value="event.data.username" />
                  {{ $t("events.objectReviewed.others") }}
                  <nuxt-link
                    :to="
                      localePath({
                        name: 'objects-id',
              ...
              <template v-if="event.type === 'level_reached'">
                <span v-if="userId === event.userId">
                  {{
                    $t("events.levelReached.yourself", {
              ...
              <template v-if="event.type === 'blog_comment_replied'">
                <span v-if="userId === event.data.userId">
                  {{ $t("events.blogCommentReplied.yourself") }}
                  <nuxt-link
                    :to="
                      localePath({
                        name: 'blog-cat-slug',
                ...
                <span v-else>
                  <username tag="b" :value="event.data.username" />
                  {{ $t("events.blogCommentReplied.others") }}
                  <nuxt-link
                    :to="
                      localePath({
                        name: 'blog-cat-slug',
              ...
              <template v-if="event.type === 'award_issued'">
                <span v-if="userId === event.userId">
                  {{ $t("events.awardIssued.yourself") }}
                  <b>"{{ event.data.title }}"</b>
                </span>
                <span v-else>
                  <username tag="b" :value="event.username" />
                  {{ $t("events.awardIssued.others") }}
                  <b>"{{ event.data.title }}"</b>
                </span>
              </template>
              <template v-if="event.type === 'object_supplemented'">
                ...
                <span v-else-if="event.data.userId === userId">
                  {{ $t("events.objectSupplemented.yourself") }}
                  <nuxt-link
                    :to="
                      localePath({
                        name: 'objects-id',
                ...
                <span v-else>
                  <username tag="b" :value="event.data.username" />
                  {{ $t("events.objectSupplemented.others") }}
                  <nuxt-link
                    :to="
                      localePath({
                        name: 'objects-id',
      ...
      <div
        class="timeline__tab timeline__tab_user"
        :class="{ isActive: activeTab === 2 }"
      >
        <UserTabs></UserTabs>
      </div>
