export default {
  ...
  profileEditPoints: "Fill in information about yourself and get 50 more points",
  ...
  login: {
    ...
    smsCodeTimeoutMessage:
        "You can resend code in {time} seconds",
  ...
  blog: {
    ...
    commentsCount:
        "0 comments | {n} comments | {n} comments | {n} comments",
    commentsSort: {
      newest: "Newest first",
      oldest: "Oldest first",
      popular: "Popular ",
  ...
  profile: {
    ...
    objects: {
      ...
      verificationErrorText: "Please leave your feedback. It won't take long, \n" +
    ...
    edit: {
      ...
      resendSmsCodeMessage:
          "You can resend code in 15 seconds",
  ...
  objects: {
    ...
    zone: {
      ...
      kidsAccessibility: "Accessibility and safety of services for children aged under 7 years",
    },
...
Anonymous requests are not considered.
    ...
    attributes: "Select from the list what exactly did not suit you at the facility",
    ...
    attribute: {
      ...
      "4e570daa-d80e-49cf-bc4f-60239c7f440b":
          "No free space around a sink",
      "7cb29da0-ea16-468e-94d4-c681dcde194d":
          "No handrails near a toilet bowl",
  ...
  detectedLocation: {
    modalText:
        "We have determined your location as {span}, are you here?",
    buttonYes: "Yes",
