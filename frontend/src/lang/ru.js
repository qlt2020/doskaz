export default {
  ...
  about: {
    ...
    section7Text2: "Помочь другим пользователям - оценив доступность <a style='color: #1534EC; font-weight: bold' href='https://doskaz.kz/objects/164485' target='_blank'>места своего посещения.</a> <br><br> <a style='color: #1534EC; font-weight: bold' href=/login' target='_blank'>Стать волонтером</a> команды «Доступный Казахстан» и внести свой вклад в развитие карты.\n",
