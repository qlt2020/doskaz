  ...
  <div class="about">
    ...
    <div class="container">
      ...
      <div class="statisticks">
        ...
        <client-only>
          <div class="ninja-block">
            <div class="pdf" ref="to_pdf">
              <div class="statistics">
                <div class="statistics-group">
                  <div class="statistics-people">
                    <div class="statistics-accessibility">
                      <div class="stat">
                        ...
                        <div class="block partially-available">
                          <div class="title">
                            {{
              ...
              <div class="statistics-complants">
                ...
                <div class="dia">
                  <div
                    class="statistics-head"
                    v-if="yearsFeedback.options.length"
                  >
                    <div class="statistics-title">
          ...
          <div class="statisticks__main">
              ...
              <div class="col-12 col-lg-8">
                <div class="row">
                  <div class="col-md-3 statisticks__main-count d-flex">
                    <div
                      class="statisticks__main-total statisticks__block mb-3"
                    >
                ...
                <div class="row mt-4 mrtop">
                  <div class="col-md-3 d-flex statisticks__main-count">
                    ...
                    >
                      <div
                        class="statisticks__main-total-title statisticks__main-total-title_diagram"
                      >
                        {{ $t("statistics.statisticsTotal.usersCount") }}
                      </div>
                      <div
                  ...
                  <div class="col-md-9">
                    <div
                      class="statisticks__block statisticks__main-offer statisticks__main-offer-two"
                    >
                      <div class="statisticks__block-head">
                        <div class="statisticks__block-head_title">
                          {{ $t("statistics.statisticsTotal.usersTotal") }}
            ...
            <div class="row statisticks__main-row mt-5" style="height: 320px">
              <div
                class="statisticks__main-feedback col-lg-2 d-flex justify-content-start"
              >
                <div
                  class="statisticks__main-feedback_total statisticks__main-total statisticks__block mb-3"
                >
                  <div class="statisticks__main-total-title">
                    {{ $t("statistics.statisticsTotal.complaintsTotal") }}
                  </div>
                ...
                <div
                  class="statisticks__main-feedback_total statisticks__main-total statisticks__block"
                >
                  <div class="statisticks__main-total-title">
                    {{ $t("statistics.statisticsTotal.feedbackTotal") }}
                  </div>
              ...
              <div
                class="statisticks__main-feedback-graph col-lg-10 d-flex justify-content-between"
              >
                <div style="margin-right: 20px" class="statisticks__block">
                  <div
...
export default {
  ...
  data() {
    return {
      ...
      usersAgeList: [
        {
          value: "from_18_to_23",
          title: this.$t("statistics.statisticsTotal.from_18_to_23"),
        },
        {
          value: "from_23_to_28",
          title: this.$t("statistics.statisticsTotal.from_23_to_28"),
        },
        {
          value: "from_28_to_33",
          title: this.$t("statistics.statisticsTotal.from_28_to_33"),
        },
        {
          value: "from_33_to_38",
          title: this.$t("statistics.statisticsTotal.from_33_to_38"),
        },
        {
          value: "from_38_to_43",
          title: this.$t("statistics.statisticsTotal.from_38_to_43"),
        },
        {
          value: "from_43_to_50",
          title: this.$t("statistics.statisticsTotal.from_43_to_50"),
        },
        {
          value: "from_50_to_100",
          title: this.$t("statistics.statisticsTotal.from_50_to_100"),
        },
      ],
      usersTitleList: [
        {
        ...
        {
          value: "undefined",
          title: this.$t("statistics.statisticsTotal.undefined"),
        },
      ],
  ...
  computed: {
    ...
    objectsCount() {
      ...
      this.objectsStat.forEach((item) => {
        ...
        partialAccessible +=
          item[`${this.selectedCategoryObj}_partial_accessible`];
      });

      return {
        fullAccessible: fullAccessible,
  ...
  methods: {
      ...
      if (complaintsSelect) {
        ...
        yearsApi.forEach((year) => {
          if (year != this.currentYear) {
            ...
            this.yearsComplaints.options.push({
        ...
        yearsApi.forEach((year) => {
          if (year != this.currentYear) {
            ...
            this.yearsFeedback.options.push({
              value: this.currentYear,
              title: this.currentYear,
            });
          }
    ...
    changeYear(value, mutation, action) {
      ...
      this.$store.commit(`statistics/${mutation}`, {
        field: "year_id",
        value: value,
      });
