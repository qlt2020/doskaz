 ...
 */
final class Version20200330152922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE daily_verification_tasks (id UUID NOT NULL, user_id INT NOT NULL, object_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, completed_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, reward INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN daily_verification_tasks.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN daily_verification_tasks.object_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN daily_verification_tasks.created_at IS \'(DC2Type:datetimetz_immutable)\'');
        $this->addSql('COMMENT ON COLUMN daily_verification_tasks.completed_at IS \'(DC2Type:datetimetz_immutable)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE daily_verification_tasks');
        $this->addSql('ALTER TABLE adding_requests ALTER data TYPE JSONB');
        $this->addSql('ALTER TABLE adding_requests ALTER data DROP DEFAULT');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file TYPE JSONB');
        $this->addSql('ALTER TABLE objects_photos_history ALTER file DROP DEFAULT');
