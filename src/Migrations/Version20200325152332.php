 ...
 */
final class Version20200325152332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tasks (id UUID NOT NULL, title TEXT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, city_id INT NOT NULL, category_id INT DEFAULT NULL, subcategory_id INT DEFAULT NULL, region geometry(POLYGON, 4326) DEFAULT NULL, PRIMARY KEY(id))');
