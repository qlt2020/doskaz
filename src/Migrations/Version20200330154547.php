 ...
 */
final class Version20200330154547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE daily_tasks ADD object_id UUID DEFAULT NULL');
        $this->addSql('ALTER TABLE daily_tasks DROP added_object_id');
        $this->addSql('ALTER TABLE daily_tasks DROP verified_object_id');
        $this->addSql('ALTER TABLE daily_tasks DROP progress');
        $this->addSql('COMMENT ON COLUMN daily_tasks.object_id IS \'(DC2Type:uuid)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE regional_representatives ALTER image TYPE JSONB');
        $this->addSql('ALTER TABLE regional_representatives ALTER image DROP DEFAULT');
        $this->addSql('ALTER TABLE daily_tasks ADD verified_object_id UUID DEFAULT NULL');
        $this->addSql('ALTER TABLE daily_tasks ADD progress INT NOT NULL');
        $this->addSql('ALTER TABLE daily_tasks RENAME COLUMN object_id TO added_object_id');
