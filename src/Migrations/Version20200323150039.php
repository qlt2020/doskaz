 ...
 */
final class Version20200323150039 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cities ADD bbox geometry(POLYGON, 0) NOT NULL');
        $this->addSql('ALTER TABLE cities DROP bounds_ne');
        $this->addSql('ALTER TABLE cities DROP bounds_sw');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE regional_representatives ALTER image TYPE JSONB');
        $this->addSql('ALTER TABLE regional_representatives ALTER image DROP DEFAULT');
        $this->addSql('ALTER TABLE cities ADD bounds_ne geography(POINT, 4326) NOT NULL');
        $this->addSql('ALTER TABLE cities ADD bounds_sw geography(POINT, 4326) NOT NULL');
        $this->addSql('ALTER TABLE cities DROP bbox');
        $this->addSql('ALTER TABLE objects ALTER zones TYPE JSONB');
        $this->addSql('ALTER TABLE objects ALTER zones DROP DEFAULT');
        $this->addSql('ALTER TABLE objects ALTER photos TYPE JSONB');
        $this->addSql('ALTER TABLE objects ALTER photos DROP DEFAULT');
